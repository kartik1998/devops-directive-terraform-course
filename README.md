...
> The tutorial has been updated to work with localstack desktop. Please download localstack desktop and run a localstack container with the image 'localstack/localstack'
